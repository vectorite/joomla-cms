...
;(function ($) {
    ...
    $.jResize = function (options) {
    	...
    	$.jResize.defaults = {
            viewPortSizes   : ["320px", "480px", "540px", "600px", "768px", "800px", "960px", "1024px", "1070px", "1280px"],
            backgroundColor : '444',
            fontColor       : 'FFF'
        }
        ...
        var credit         = '<div style="font-weight:bold;float:right;padding:13px 25px;font-size:12px;line-height:12px;">New Internet Marketing</div>';
